...
@Configuration
public class KafkaCustomerProducerConfiguration {
    ...
    @Bean
    public KafkaTemplate<String, Customer> kafkaCustomerTemplate(ProducerFactory<String, Customer> producerCustomerFactory) {
